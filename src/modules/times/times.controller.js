function createTimesController(service) {
  return {
    ...
    async updateStatus(req, res, next) { try { res.json(await service.updateStatus(req.params.bolaoId, req.params.id, req.body, req.auth)); } catch (e) { next(e); } }
  };
}
module.exports = { createTimesController };
