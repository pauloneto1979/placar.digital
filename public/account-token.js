...
const flowSubtitle = document.querySelector('#flowSubtitle');
...
i18n.ready.then(async () => {
  ...
  if (flow === 'reset' && token) {
    ...
    if (flowSubtitle) flowSubtitle.textContent = t('passwordReset.resetSubtitle');
  } else if (flow === 'reset') {
    requestForm.hidden = false;
    tokenForm.hidden = true;
    if (flowSubtitle) flowSubtitle.textContent = t('passwordReset.requestSubtitle');
  }
